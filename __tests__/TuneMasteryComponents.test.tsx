...
import PracticePanel, {
  type PracticePanelSettings,
} from "../src/screens/TuneMastery/components/PracticePanel";
import type { TuneMasterySettings } from "../src/types/tuning";
...
describe("PracticePanel", () => {
  const defaultSettings: PracticePanelSettings = {
    tunerMode: "needle",
    temperament: "equal",
    autoMetronome: false,
    autoDrone: false,
