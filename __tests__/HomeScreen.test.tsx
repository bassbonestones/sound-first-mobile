...
describe("HomeScreen", () => {
  ...
  describe("Instrument emoji mapping", () => {
    it("shows trombone emoji for trombone instrument", () => {
      const { getByText } = render(<HomeScreen navigation={mockNavigation} />);
      expect(getByText("🎺")).toBeTruthy();
    });

    it("shows saxophone emoji for saxophone", () => {
      mockUserContext.selectedInstrument = {
        id: 3,
    ...
    it("shows piano emoji for piano", () => {
      mockUserContext.selectedInstrument = {
        id: 3,
    ...
    it("shows clarinet emoji for clarinet", () => {
      mockUserContext.selectedInstrument = {
        id: 3,
    ...
    it("shows flute emoji for flute", () => {
      mockUserContext.selectedInstrument = {
        id: 3,
    ...
    it("shows violin emoji for violin", () => {
      mockUserContext.selectedInstrument = {
        id: 3,
    ...
    it("shows guitar emoji for guitar", () => {
      mockUserContext.selectedInstrument = {
        id: 3,
    ...
    it("shows default emoji for unknown instrument", () => {
      mockUserContext.selectedInstrument = {
        id: 3,
      ...
      // Should show default music note
      expect(getAllByText("🎵").length).toBeGreaterThanOrEqual(1);
    });
  });
