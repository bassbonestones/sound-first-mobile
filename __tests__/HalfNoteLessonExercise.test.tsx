...
describe("HalfNoteLessonExercise", () => {
  const defaultProps = {
  ...
  describe("Sing Phase", () => {
    ...
    it("shows sing instructions", () => {
      ...
      goToSingPhase(getByText);
      expect(getByText(/Sing the half note on solfege/)).toBeTruthy();
    });
    ...
    it("shows sing phase elements including volume container", () => {
      ...
      goToSingPhase(getByText);
      // The Sing phase should have the Start Singing button which implies volume indicator is also present
      expect(getByText("🎤 Start Singing")).toBeTruthy();
    });
  ...
  describe("Imagine Phase", () => {
    ...
    it("shows imagine instructions", () => {
      ...
      goToImaginePhase(getByText, getAllByText);
      expect(getByText(/Imagine playing this half note/)).toBeTruthy();
    });
    ...
    it("shows imagination visual cue", () => {
      ...
      expect(getByText(/Hear: 1 - 2 - \(3\) stop/)).toBeTruthy();
    });
  ...
  describe("Play Phase", () => {
    ...
    it("shows play instructions", () => {
      ...
      goToPlayPhase(getByText, getAllByText);
      expect(getByText(/Play the half note on your instrument/)).toBeTruthy();
    });
  ...
  describe("Progress reporting", () => {
    ...
    it("uses custom mastery streak from config", () => {
      ...
      render(
        <HalfNoteLessonExercise {...defaultProps} mastery={customMastery} />,
      );
  ...
  describe("Config options", () => {
    it("uses default BPM when not specified", () => {
      const { getByText } = render(
        <HalfNoteLessonExercise {...defaultProps} config={{}} />,
      );
      expect(getByText("Half Note")).toBeTruthy();
    });
    ...
    it("accepts custom BPM", () => {
      const { getByText } = render(
        <HalfNoteLessonExercise {...defaultProps} config={{ bpm: 80 }} />,
      );
      expect(getByText("Half Note")).toBeTruthy();
    });
    ...
    it("accepts clef config", () => {
      const { getByText } = render(
        <HalfNoteLessonExercise {...defaultProps} config={{ clef: "bass" }} />,
      );
      expect(getByText("Half Note")).toBeTruthy();
    });
  });
  ...
  describe("Edge cases", () => {
    ...
    it("handles undefined userFirstNote gracefully", () => {
      const { getByText } = render(
        <HalfNoteLessonExercise {...defaultProps} userFirstNote={undefined} />,
      );
      expect(getByText("Half Note")).toBeTruthy();
    });
