...
export default function AudioInput({
  ...
  }, [onVolumeChange, onSoundStart, onSoundEnd, onRealtimePitch, onPitchDetected, onPitchMatch]);
  ...
  }, [onVolumeChange, onSoundStart, onSoundEnd, volumeThreshold, silenceDuration]);
  ...
  if (Platform.OS !== "web") {
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.errorText}>Audio input not available on this device</Text>
      </View>
    );
  }
