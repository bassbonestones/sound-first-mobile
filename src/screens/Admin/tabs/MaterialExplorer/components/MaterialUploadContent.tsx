...
interface UploadHook {
  ...
  keyCenter: string;
  setKeyCenter: (keyCenter: string) => void;
...
interface MaterialUploadContentProps {
  uploadHook: UploadHook;
  softGateHelp?: Record<string, unknown>;
}

export default function MaterialUploadContent({
  uploadHook,
  softGateHelp,
}: MaterialUploadContentProps) {
  const {
    step: uploadStep,
