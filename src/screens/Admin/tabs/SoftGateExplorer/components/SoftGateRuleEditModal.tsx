...
interface SoftGateRule {
  id: number;
  dimension_name: string;
  frontier_buffer: number;
  promotion_step: number;
  min_attempts: number;
  success_rating_threshold: number;
  success_required_count: number;
  success_window_count?: number;
  decay_halflife_days?: number;
}

interface SoftGateRuleEditModalProps {
  rule: SoftGateRule;
  onClose: () => void;
  onSave: () => Promise<void>;
  onDelete: () => void;
