/**
 * WholeNoteLessonExercise - Refactored to use shared hooks
 *
 * Uses:
...
export default function WholeNoteLessonExercise({
  ...
  const bpm =
    ...
    WHOLE_NOTE_CONFIG.defaultTempo;
  const masteryStreak =
  ...
  const audio = useLessonExerciseAudio({
    tempo: bpm,
    noteConfig: {
      beatsPerNote: WHOLE_NOTE_CONFIG.beatsPerNote,
      includeSubdivision: WHOLE_NOTE_CONFIG.hasSubdivision,
    },
  });
          ...
          <View style={styles.beatIndicator}>
            ...
            <View
              style={[
                styles.beatDot,
                styles.beatDotStop,
                audio.currentBeat === 5 && styles.beatDotStopActive,
              ]}
            >
              <Text
                style={[
                  styles.beatNumber,
                  audio.currentBeat === 5 && styles.beatNumberStopActive,
                ]}
              >
                1
              </Text>
        ...
        >
          <View style={styles.successContainer}>
            ...
            <Text style={styles.successText}>
              {"You've mastered the whole note rhythm!"}
            </Text>
          </View>
        </ScrollView>
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Text style={styles.instruction}>
            ...
            Hold for 4 beats, ending on the next ONE.
          </Text>
