...
interface MiniSession {
  ...
  lesson_display_name?: string;
  lesson_description?: string;
  lesson_intro?: string;
  exercise_template_id?: string;
  exercise_config?: object;
  mastery_config?: {
...
interface TeachingModuleSessionProps {
  mini: MiniSession;
  userResonantNote?: string;
  onRecordCompletion?: (result: ExerciseResult) => void;
  onNavigate?: () => void;
  onSkip?: () => void;
  onEndPractice?: () => void;
  onExtend?: () => void;
