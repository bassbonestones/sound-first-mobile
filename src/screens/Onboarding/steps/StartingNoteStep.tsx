...
interface PlayToSelectModeProps {
  instrumentIcon: string;
  detectedPitch: DetectedPitch | null;
  isSounding: boolean;
  onRealtimePitch: (pitch: DetectedPitch) => void;
  onFinalPitch: (pitch: DetectedPitch) => void;
  onSoundEnd: () => void;
  onConfirm: () => void;
  onBack: () => void;
}
...
interface StaffSelectModeProps {
  instrumentIcon: string;
  instrument: string;
  clef: string;
  startingNote: string;
...
interface StartingNoteStepProps {
  instrument: string;
  instrumentIcon: string;
  clef: string;
  startingNote: string;
  ...
  onSoundEnd: () => void;
  onConfirmPitch: () => void;
  onSetPlayToSelectMode: (mode: boolean) => void;
  onBack: () => void;
  onSubmit: () => void;
}
