...
import {
  Stage0Content, Stage0Buttons,
  Stage1Content, Stage1Buttons,
  Stage2Content, Stage2Buttons,
  Stage3Content, Stage3Buttons,
  Stage4Content, Stage4Buttons,
  Stage5Content, Stage5Buttons,
  Stage6Content, Stage6Buttons,
  Stage7Content, Stage7Buttons,
} from './stages';
...
const FirstNoteContent = () => {
  ...
  const renderStage = () => {
    switch (stage) {
      ...
      case 7: return <Stage7Content />;
      default: return <Stage0Content />;
    }
  };
  ...
  const renderBottomButtons = () => {
    switch (stage) {
      case 0: return <Stage0Buttons />;
      case 1: return <Stage1Buttons />;
      case 2: return <Stage2Buttons />;
      case 3: return <Stage3Buttons />;
      case 4: return <Stage4Buttons />;
      case 5: return <Stage5Buttons />;
      case 6: return <Stage6Buttons />;
      case 7: return <Stage7Buttons />;
      default: return null;
    }
  };
