...
export type InstrumentFamilies = Record<string, InstrumentFamily>;
export type InstrumentDefaultsMap = Record<string, InstrumentDefaults>;

// Instrument families with their instruments
export const instrumentFamilies: InstrumentFamilies = {
  Brass: {
    icon: "🎺",
    instruments: [
...
export const instrumentDefaults: InstrumentDefaultsMap = {
  // Keyboard
 ...
 */
export function getInstrument(name: string): Instrument | null {
 ...
 */
export function getInstrumentFamily(instrumentName: string): string | null {
