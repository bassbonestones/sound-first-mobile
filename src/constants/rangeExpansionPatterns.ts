...
export interface RangeExpansionPattern {
  id: string;
  name: string;
...
export const PATTERNS_UP: RangeExpansionPattern[] = [
  {
...
export const PATTERNS_DOWN: RangeExpansionPattern[] = [
  {
...
export const ALL_PATTERNS: RangeExpansionPattern[] = [
  ...PATTERNS_UP,
  ...PATTERNS_DOWN,
];
...
export function getAvailablePatterns(
  direction: PatternDirection,
  currentRangeSemitones: number,
): RangeExpansionPattern[] {
  const patterns = direction === "up" ? PATTERNS_UP : PATTERNS_DOWN;
  return patterns.filter(
    (p) => p.requiredRangeSemitones <= currentRangeSemitones,
  );
}
 ...
 */
export function getSimplestPattern(
  direction: PatternDirection,
  currentRangeSemitones: number,
): RangeExpansionPattern | null {
